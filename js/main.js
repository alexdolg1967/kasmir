...
var curnum = document.querySelector(".number .current");
var pagcur = document.querySelector(".slider-pagination-current__num");
mainSlider.on("slideChange", function () {
  var index = mainSlider.realIndex + 1,
      indexRes = index >= 10 ? index : "0".concat(index);
